...
# plots=plt.show()
# plt.show()
fig.savefig(out_dir + '\\graphs\\plots' + station_d)
print("\n")
...
plt.legend()
# plt.show()
fig.savefig(out_dir + '\\graphs\\comm_inflow_vs_comm_outflow' + station_d)
print('NS = ', NS)
