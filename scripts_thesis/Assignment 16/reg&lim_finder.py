...
Betas_df = pd.DataFrame(Betas, index=idx, columns=['betas_org'])
pd.to_pickle(Betas_df, 'beta_arr' + station_p)
...
'''
cols = (temp_col, prec_col, pet_col, api_col , Betas_col) = (0, 1, 2, 3, 4)
