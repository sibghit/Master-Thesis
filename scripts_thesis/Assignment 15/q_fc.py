...
for i in range(strt_idx, bs.shape[0]):
    ...
    if ((cr[q1_col] - pr[q1_col] >= rising_limit)
        & (cr[q2_col] - pr[q2_col] >= rising_limit)
        & (cr[q3_col] - pr[q3_col] >= rising_limit)):
        beta = Beta_1

    elif ((cr[q1_col] - pr[q1_col] <= recession_limit)
        & (cr[q2_col] - pr[q2_col] <= recession_limit)
        & (cr[q3_col] - pr[q3_col] <= recession_limit)):
        beta = Beta_2
